...
class ReturnService
{
     ...
     */
    public function process(int $transactionId, array $unitIds): Transaction
    {
        ...
        return DB::transaction(function () use ($transaction, $unitIds) {
            ...
            $remainingBorrowed = TransactionDetail::where('transaction_id', $transaction->id)
            ...
            return $transaction->fresh()->load(['student.class', 'details.unit.item']);
        });
    }
}
